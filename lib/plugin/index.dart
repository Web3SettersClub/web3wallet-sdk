...
import 'package:web3wallet_sdk/api/types/balanceData.dart';
import 'package:web3wallet_sdk/api/types/networkParams.dart';
import 'package:web3wallet_sdk/api/types/networkStateData.dart';
...
abstract class Web3WalletPluginBase {
  ...
  /// for display in Assets page of Web3Wallet App.
  final Map<String, Widget> tokenIcons = {};

  /// The [getNavItems] method returns a list of [HomeNavItem] which defines
  /// the [Widget] to be used in home page of Web3 Wallet App.
...
class PluginBasicData {
  ...
  ///
  /// Web3 Wallet App will perform hot-update for the js code
