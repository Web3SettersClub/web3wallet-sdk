...
import 'package:web3wallet_sdk/api/apiAccount.dart';
import 'package:web3wallet_sdk/api/apiAssets.dart';
import 'package:web3wallet_sdk/api/apiGov.dart';
import 'package:web3wallet_sdk/api/apiKeyring.dart';
import 'package:web3wallet_sdk/api/apiParachain.dart';
import 'package:web3wallet_sdk/api/apiRecovery.dart';
import 'package:web3wallet_sdk/api/apiSetting.dart';
import 'package:web3wallet_sdk/api/apiStaking.dart';
import 'package:web3wallet_sdk/api/apiTx.dart';
import 'package:web3wallet_sdk/api/apiUOS.dart';
import 'package:web3wallet_sdk/api/apiWalletConnect.dart';
import 'package:web3wallet_sdk/api/subscan.dart';
...
/// The [Web3WalletApi] instance is the wrapper of `polkadot-js/api`.
/// It provides:
...
/// * [ApiUOS], provides the offline-signature ability of the Web3 Wallet.
