...
import 'package:web3wallet_sdk/service/jaguar_flutter_asset.dart';
...
class WebViewRunner {
  ...
  Future<void> _startLocalServer() async {
    final cert = await rootBundle
        .load("packages/web3wallet_sdk/lib/ssl/certificate.text");
    final keys =
        await rootBundle.load("packages/web3wallet_sdk/lib/ssl/keys.text");
